    ...
    <main>
      <section className='z-1'>
        ...
        <div className='pt-8'>
          ...
          <ul className='flex justify-center gap-8 md:gap-12 w-screen max-w-240 mt-4 overflow-x-scroll no-scrollbar translate-y-1'>
            {categorias.map((categoria, index) => (
              <li
                key={index}
                className='flex flex-col items-center text-center gap-2'
              >
                <button onClick={() => setActive(index)}>{categoria}</button>
                <div
                  className={`h-2 w-[120%] ${
              ...
              >
                <div className='flex flex-col gap-2 items-center min-w-20 my-auto'>
                  ...
                  <div className='flex gap-2 items-center'>
                    ...
                    <p className='text-sm'>
                      <span className='text-lg'>{module.xp_recompensa}</span> xp
                    </p>
                  </div>
                </div>
                <div>
                  <div>
                    <h3 className='font-bold text-xl mb-2'>{module.titulo}</h3>
